...
IfcAirTerminal::~IfcAirTerminal() {}
shared_ptr<IfcPPObject> IfcAirTerminal::getDeepCopy()
{
	...
	if( m_PredefinedType ) { copy_self->m_PredefinedType = dynamic_pointer_cast<IfcAirTerminalTypeEnum>( m_PredefinedType->getDeepCopy() ); }
	return copy_self;
}
