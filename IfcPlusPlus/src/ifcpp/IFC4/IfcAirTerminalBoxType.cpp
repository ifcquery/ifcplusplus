...
IfcAirTerminalBoxType::~IfcAirTerminalBoxType() {}
shared_ptr<IfcPPObject> IfcAirTerminalBoxType::getDeepCopy()
{
	...
	if( m_PredefinedType ) { copy_self->m_PredefinedType = dynamic_pointer_cast<IfcAirTerminalBoxTypeEnum>( m_PredefinedType->getDeepCopy() ); }
	return copy_self;
}
