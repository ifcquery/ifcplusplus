...
IfcAudioVisualApplianceType::~IfcAudioVisualApplianceType() {}
shared_ptr<IfcPPObject> IfcAudioVisualApplianceType::getDeepCopy()
{
	...
	if( m_PredefinedType ) { copy_self->m_PredefinedType = dynamic_pointer_cast<IfcAudioVisualApplianceTypeEnum>( m_PredefinedType->getDeepCopy() ); }
	return copy_self;
}
