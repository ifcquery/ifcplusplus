...
IfcBSplineCurveForm::~IfcBSplineCurveForm() {}
shared_ptr<IfcPPObject> IfcBSplineCurveForm::getDeepCopy()
{
...
shared_ptr<IfcBSplineCurveForm> IfcBSplineCurveForm::createObjectFromStepData( const std::wstring& arg )
{
	// read TYPE
