...
IfcBeamStandardCase::~IfcBeamStandardCase() {}
shared_ptr<IfcPPObject> IfcBeamStandardCase::getDeepCopy()
{
	...
	if( m_PredefinedType ) { copy_self->m_PredefinedType = dynamic_pointer_cast<IfcBeamTypeEnum>( m_PredefinedType->getDeepCopy() ); }
	return copy_self;
}
