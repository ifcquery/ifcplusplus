...
IfcBoilerType::~IfcBoilerType() {}
shared_ptr<IfcPPObject> IfcBoilerType::getDeepCopy()
{
	...
	if( m_PredefinedType ) { copy_self->m_PredefinedType = dynamic_pointer_cast<IfcBoilerTypeEnum>( m_PredefinedType->getDeepCopy() ); }
	return copy_self;
}
