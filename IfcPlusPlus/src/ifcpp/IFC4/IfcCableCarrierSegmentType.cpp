...
IfcCableCarrierSegmentType::~IfcCableCarrierSegmentType() {}
shared_ptr<IfcPPObject> IfcCableCarrierSegmentType::getDeepCopy()
{
	...
	if( m_PredefinedType ) { copy_self->m_PredefinedType = dynamic_pointer_cast<IfcCableCarrierSegmentTypeEnum>( m_PredefinedType->getDeepCopy() ); }
	return copy_self;
}
...
void IfcCableCarrierSegmentType::readStepArguments( const std::vector<std::wstring>& args, const std::map<int,shared_ptr<IfcPPEntity> >& map )
{
	...
	m_PredefinedType = IfcCableCarrierSegmentTypeEnum::createObjectFromStepData( args[9] );
}
