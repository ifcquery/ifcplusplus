...
IfcCableSegmentType::~IfcCableSegmentType() {}
shared_ptr<IfcPPObject> IfcCableSegmentType::getDeepCopy()
{
	...
	if( m_PredefinedType ) { copy_self->m_PredefinedType = dynamic_pointer_cast<IfcCableSegmentTypeEnum>( m_PredefinedType->getDeepCopy() ); }
	return copy_self;
}
