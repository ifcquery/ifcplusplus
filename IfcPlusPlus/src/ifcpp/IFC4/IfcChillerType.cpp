...
IfcChillerType::~IfcChillerType() {}
shared_ptr<IfcPPObject> IfcChillerType::getDeepCopy()
{
	...
	if( m_PredefinedType ) { copy_self->m_PredefinedType = dynamic_pointer_cast<IfcChillerTypeEnum>( m_PredefinedType->getDeepCopy() ); }
	return copy_self;
}
