...
IfcClassificationSelect::~IfcClassificationSelect() {}
shared_ptr<IfcClassificationSelect> IfcClassificationSelect::createObjectFromStepData( const std::wstring& arg, const std::map<int,shared_ptr<IfcPPEntity> >& map )
{
	// Read SELECT TYPE
