...
IfcColumnStandardCase::~IfcColumnStandardCase() {}
shared_ptr<IfcPPObject> IfcColumnStandardCase::getDeepCopy()
{
	...
	if( m_PredefinedType ) { copy_self->m_PredefinedType = dynamic_pointer_cast<IfcColumnTypeEnum>( m_PredefinedType->getDeepCopy() ); }
	return copy_self;
}
