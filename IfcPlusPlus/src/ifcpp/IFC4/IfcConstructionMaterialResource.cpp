...
IfcConstructionMaterialResource::~IfcConstructionMaterialResource() {}
shared_ptr<IfcPPObject> IfcConstructionMaterialResource::getDeepCopy()
{
	...
	if( m_PredefinedType ) { copy_self->m_PredefinedType = dynamic_pointer_cast<IfcConstructionMaterialResourceTypeEnum>( m_PredefinedType->getDeepCopy() ); }
	return copy_self;
}
