...
IfcDamperType::~IfcDamperType() {}
shared_ptr<IfcPPObject> IfcDamperType::getDeepCopy()
{
	...
	if( m_PredefinedType ) { copy_self->m_PredefinedType = dynamic_pointer_cast<IfcDamperTypeEnum>( m_PredefinedType->getDeepCopy() ); }
	return copy_self;
}
