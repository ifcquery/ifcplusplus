...
IfcDistributionChamberElementType::IfcDistributionChamberElementType( int id ) { m_id = id; }
IfcDistributionChamberElementType::~IfcDistributionChamberElementType() {}
shared_ptr<IfcPPObject> IfcDistributionChamberElementType::getDeepCopy()
{
...
void IfcDistributionChamberElementType::readStepArguments( const std::vector<std::wstring>& args, const std::map<int,shared_ptr<IfcPPEntity> >& map )
{
	...
	m_PredefinedType = IfcDistributionChamberElementTypeEnum::createObjectFromStepData( args[9] );
}
