...
IfcDuctSilencerType::~IfcDuctSilencerType() {}
shared_ptr<IfcPPObject> IfcDuctSilencerType::getDeepCopy()
{
	...
	if( m_PredefinedType ) { copy_self->m_PredefinedType = dynamic_pointer_cast<IfcDuctSilencerTypeEnum>( m_PredefinedType->getDeepCopy() ); }
	return copy_self;
}
