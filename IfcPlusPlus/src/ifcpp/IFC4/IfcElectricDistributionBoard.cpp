...
IfcElectricDistributionBoard::~IfcElectricDistributionBoard() {}
shared_ptr<IfcPPObject> IfcElectricDistributionBoard::getDeepCopy()
{
	...
	if( m_PredefinedType ) { copy_self->m_PredefinedType = dynamic_pointer_cast<IfcElectricDistributionBoardTypeEnum>( m_PredefinedType->getDeepCopy() ); }
	return copy_self;
}
