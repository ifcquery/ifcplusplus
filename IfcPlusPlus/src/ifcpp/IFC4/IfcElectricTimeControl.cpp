...
IfcElectricTimeControl::~IfcElectricTimeControl() {}
shared_ptr<IfcPPObject> IfcElectricTimeControl::getDeepCopy()
{
	...
	if( m_PredefinedType ) { copy_self->m_PredefinedType = dynamic_pointer_cast<IfcElectricTimeControlTypeEnum>( m_PredefinedType->getDeepCopy() ); }
	return copy_self;
}
