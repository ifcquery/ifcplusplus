...
void IfcElementAssembly::setEntity( shared_ptr<IfcPPEntity> other_entity )
{
...
void IfcElementAssembly::readStepArguments( const std::vector<std::string>& args, const std::map<int,shared_ptr<IfcPPEntity> >& map )
{
