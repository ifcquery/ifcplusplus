...
IfcFlowMeterType::~IfcFlowMeterType() {}
shared_ptr<IfcPPObject> IfcFlowMeterType::getDeepCopy()
{
	...
	if( m_PredefinedType ) { copy_self->m_PredefinedType = dynamic_pointer_cast<IfcFlowMeterTypeEnum>( m_PredefinedType->getDeepCopy() ); }
	return copy_self;
}
