...
void IfcFurnitureType::setEntity( shared_ptr<IfcPPEntity> other_entity )
{
...
void IfcFurnitureType::readStepArguments( const std::vector<std::string>& args, const std::map<int,shared_ptr<IfcPPEntity> >& map )
{
