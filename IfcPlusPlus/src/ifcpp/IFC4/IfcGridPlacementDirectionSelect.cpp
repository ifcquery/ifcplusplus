...
IfcGridPlacementDirectionSelect::~IfcGridPlacementDirectionSelect() {}
shared_ptr<IfcGridPlacementDirectionSelect> IfcGridPlacementDirectionSelect::createObjectFromStepData( const std::wstring& arg, const std::map<int,shared_ptr<IfcPPEntity> >& map )
{
	// Read SELECT TYPE
