...
IfcJunctionBoxType::~IfcJunctionBoxType() {}
shared_ptr<IfcPPObject> IfcJunctionBoxType::getDeepCopy()
{
	...
	if( m_PredefinedType ) { copy_self->m_PredefinedType = dynamic_pointer_cast<IfcJunctionBoxTypeEnum>( m_PredefinedType->getDeepCopy() ); }
	return copy_self;
}
