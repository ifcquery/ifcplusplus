...
IfcLaborResourceType::~IfcLaborResourceType() {}
shared_ptr<IfcPPObject> IfcLaborResourceType::getDeepCopy()
{
	...
	if( m_PredefinedType ) { copy_self->m_PredefinedType = dynamic_pointer_cast<IfcLaborResourceTypeEnum>( m_PredefinedType->getDeepCopy() ); }
	return copy_self;
}
