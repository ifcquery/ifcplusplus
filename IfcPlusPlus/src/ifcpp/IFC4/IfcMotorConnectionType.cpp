...
IfcMotorConnectionType::~IfcMotorConnectionType() {}
shared_ptr<IfcPPObject> IfcMotorConnectionType::getDeepCopy()
{
	...
	if( m_PredefinedType ) { copy_self->m_PredefinedType = dynamic_pointer_cast<IfcMotorConnectionTypeEnum>( m_PredefinedType->getDeepCopy() ); }
	return copy_self;
}
