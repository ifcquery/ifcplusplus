...
IfcPipeFitting::~IfcPipeFitting() {}
shared_ptr<IfcPPObject> IfcPipeFitting::getDeepCopy()
{
	...
	if( m_PredefinedType ) { copy_self->m_PredefinedType = dynamic_pointer_cast<IfcPipeFittingTypeEnum>( m_PredefinedType->getDeepCopy() ); }
	return copy_self;
}
