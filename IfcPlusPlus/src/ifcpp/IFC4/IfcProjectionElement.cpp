...
IfcProjectionElement::~IfcProjectionElement() {}
shared_ptr<IfcPPObject> IfcProjectionElement::getDeepCopy()
{
	...
	if( m_PredefinedType ) { copy_self->m_PredefinedType = dynamic_pointer_cast<IfcProjectionElementTypeEnum>( m_PredefinedType->getDeepCopy() ); }
	return copy_self;
}
