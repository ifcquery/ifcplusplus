...
IfcProtectiveDeviceTrippingUnit::~IfcProtectiveDeviceTrippingUnit() {}
shared_ptr<IfcPPObject> IfcProtectiveDeviceTrippingUnit::getDeepCopy()
{
	...
	if( m_PredefinedType ) { copy_self->m_PredefinedType = dynamic_pointer_cast<IfcProtectiveDeviceTrippingUnitTypeEnum>( m_PredefinedType->getDeepCopy() ); }
	return copy_self;
}
