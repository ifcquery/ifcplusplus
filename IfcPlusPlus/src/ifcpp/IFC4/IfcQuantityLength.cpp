...
IfcQuantityLength::~IfcQuantityLength() {}
shared_ptr<IfcPPObject> IfcQuantityLength::getDeepCopy()
{
	...
	if( m_LengthValue ) { copy_self->m_LengthValue = dynamic_pointer_cast<IfcLengthMeasure>( m_LengthValue->getDeepCopy() ); }
