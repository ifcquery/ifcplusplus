...
IfcQuantityVolume::~IfcQuantityVolume() {}
shared_ptr<IfcPPObject> IfcQuantityVolume::getDeepCopy()
{
	...
	if( m_VolumeValue ) { copy_self->m_VolumeValue = dynamic_pointer_cast<IfcVolumeMeasure>( m_VolumeValue->getDeepCopy() ); }
