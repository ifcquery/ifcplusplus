...
shared_ptr<IfcSegmentIndexSelect> IfcSegmentIndexSelect::createObjectFromSTEP( const std::wstring& arg, const boost::unordered_map<int,shared_ptr<IfcPPEntity> >& map )
{
	// read TYPE
