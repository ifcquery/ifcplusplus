...
IfcSpecularHighlightSelect::~IfcSpecularHighlightSelect() {}
shared_ptr<IfcSpecularHighlightSelect> IfcSpecularHighlightSelect::createObjectFromStepData( const std::wstring& arg, const std::map<int,shared_ptr<IfcPPEntity> >& map )
{
	// Read SELECT TYPE
