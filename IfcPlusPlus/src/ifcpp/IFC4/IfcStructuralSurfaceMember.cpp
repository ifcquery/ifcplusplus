...
IfcStructuralSurfaceMember::~IfcStructuralSurfaceMember() {}
shared_ptr<IfcPPObject> IfcStructuralSurfaceMember::getDeepCopy()
{
	...
	if( m_PredefinedType ) { copy_self->m_PredefinedType = dynamic_pointer_cast<IfcStructuralSurfaceMemberTypeEnum>( m_PredefinedType->getDeepCopy() ); }
