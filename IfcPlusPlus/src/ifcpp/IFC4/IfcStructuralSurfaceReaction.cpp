...
IfcStructuralSurfaceReaction::~IfcStructuralSurfaceReaction() {}
shared_ptr<IfcPPObject> IfcStructuralSurfaceReaction::getDeepCopy()
{
	...
	if( m_PredefinedType ) { copy_self->m_PredefinedType = dynamic_pointer_cast<IfcStructuralSurfaceActivityTypeEnum>( m_PredefinedType->getDeepCopy() ); }
	return copy_self;
}
