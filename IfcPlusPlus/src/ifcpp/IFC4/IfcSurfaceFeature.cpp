...
IfcSurfaceFeature::~IfcSurfaceFeature() {}
shared_ptr<IfcPPObject> IfcSurfaceFeature::getDeepCopy()
{
	...
	if( m_PredefinedType ) { copy_self->m_PredefinedType = dynamic_pointer_cast<IfcSurfaceFeatureTypeEnum>( m_PredefinedType->getDeepCopy() ); }
	return copy_self;
}
