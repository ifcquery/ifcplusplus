...
IfcSurfaceStyleElementSelect::~IfcSurfaceStyleElementSelect() {}
shared_ptr<IfcSurfaceStyleElementSelect> IfcSurfaceStyleElementSelect::createObjectFromStepData( const std::wstring& arg, const std::map<int,shared_ptr<IfcPPEntity> >& map )
{
	// Read SELECT TYPE
