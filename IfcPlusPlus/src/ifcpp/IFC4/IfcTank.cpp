...
IfcTank::~IfcTank() {}
shared_ptr<IfcPPObject> IfcTank::getDeepCopy()
{
	...
	if( m_PredefinedType ) { copy_self->m_PredefinedType = dynamic_pointer_cast<IfcTankTypeEnum>( m_PredefinedType->getDeepCopy() ); }
	return copy_self;
}
