...
IfcVoidingFeature::~IfcVoidingFeature() {}
shared_ptr<IfcPPObject> IfcVoidingFeature::getDeepCopy()
{
	...
	if( m_PredefinedType ) { copy_self->m_PredefinedType = dynamic_pointer_cast<IfcVoidingFeatureTypeEnum>( m_PredefinedType->getDeepCopy() ); }
	return copy_self;
}
