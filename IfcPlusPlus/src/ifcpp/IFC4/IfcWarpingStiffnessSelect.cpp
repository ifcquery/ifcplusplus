...
IfcWarpingStiffnessSelect::~IfcWarpingStiffnessSelect() {}
shared_ptr<IfcWarpingStiffnessSelect> IfcWarpingStiffnessSelect::createObjectFromStepData( const std::wstring& arg, const std::map<int,shared_ptr<IfcPPEntity> >& map )
{
	// Read SELECT TYPE
