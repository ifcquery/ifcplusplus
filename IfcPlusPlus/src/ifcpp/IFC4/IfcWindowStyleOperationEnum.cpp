...
IfcWindowStyleOperationEnum::~IfcWindowStyleOperationEnum() {}
shared_ptr<IfcPPObject> IfcWindowStyleOperationEnum::getDeepCopy()
{
...
shared_ptr<IfcWindowStyleOperationEnum> IfcWindowStyleOperationEnum::createObjectFromStepData( const std::wstring& arg )
{
	// read TYPE
