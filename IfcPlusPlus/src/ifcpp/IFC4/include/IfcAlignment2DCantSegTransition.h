...
//ENTITY
class IFCQUERY_EXPORT IfcAlignment2DCantSegTransition : public IfcAlignment2DCantSegment
{ 
public:
	IfcAlignment2DCantSegTransition() = default;
	IfcAlignment2DCantSegTransition( int id );
	~IfcAlignment2DCantSegTransition() = default;
	...
	virtual const char* className() const { return "IfcAlignment2DCantSegTransition"; }
