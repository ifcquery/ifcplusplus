...
class IFCQUERY_EXPORT IfcCurveSegment2D;
class IFCQUERY_EXPORT IfcAlignment2DHorizontal;
//ENTITY
class IFCQUERY_EXPORT IfcAlignment2DHorizontalSegment : public IfcAlignment2DSegment
{ 
public:
	IfcAlignment2DHorizontalSegment() = default;
