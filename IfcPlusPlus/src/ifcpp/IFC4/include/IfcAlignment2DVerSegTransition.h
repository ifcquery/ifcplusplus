...
//ENTITY
class IFCQUERY_EXPORT IfcAlignment2DVerSegTransition : public IfcAlignment2DVerticalSegment
{ 
public:
	IfcAlignment2DVerSegTransition() = default;
	IfcAlignment2DVerSegTransition( int id );
	~IfcAlignment2DVerSegTransition() = default;
	...
	virtual const char* className() const { return "IfcAlignment2DVerSegTransition"; }
