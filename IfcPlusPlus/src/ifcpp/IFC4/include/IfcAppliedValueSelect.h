...
class IfcAppliedValueSelect : virtual public IfcPPObject
{
public:
	...
	static shared_ptr<IfcAppliedValueSelect> createObjectFromStepData( const std::wstring& arg, const std::map<int,shared_ptr<IfcPPEntity> >& map );
};
