...
class IfcBooleanOperand : virtual public IfcPPObject
{
public:
	IfcBooleanOperand();
	~IfcBooleanOperand();
	...
	static shared_ptr<IfcBooleanOperand> createObjectFromStepData( const std::wstring& arg, const std::map<int,shared_ptr<IfcPPEntity> >& map );
};
