...
class IFCQUERY_EXPORT IfcFacilityPartTypeSelect;
...
public:
	...
	virtual const char* className() const { return "IfcFacilityPart"; }
	...
	// IfcFacilityPart -----------------------------------------------------------
	// attributes:
	shared_ptr<IfcFacilityPartTypeSelect>						m_PredefinedType;
