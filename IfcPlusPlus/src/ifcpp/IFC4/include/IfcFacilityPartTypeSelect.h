...
class IFCQUERY_EXPORT IfcFacilityPartTypeSelect : virtual public BuildingObject
{
public:
	...
	static shared_ptr<IfcFacilityPartTypeSelect> createObjectFromSTEP( const std::wstring& arg, const std::map<int,shared_ptr<BuildingEntity> >& map );
};
