...
class IfcFillStyleSelect : virtual public IfcPPObject
{
public:
	IfcFillStyleSelect();
	~IfcFillStyleSelect();
	...
	static shared_ptr<IfcFillStyleSelect> createObjectFromStepData( const std::wstring& arg, const std::map<int,shared_ptr<IfcPPEntity> >& map );
};
