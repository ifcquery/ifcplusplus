...
class IFCQUERY_EXPORT IfcImpactProtectionDeviceTypeSelect;
//ENTITY
...
public:
	...
	virtual const char* className() const { return "IfcImpactProtectionDevice"; }
	...
	// attributes:
	shared_ptr<IfcImpactProtectionDeviceTypeSelect>				m_PredefinedType;			//optional
};
