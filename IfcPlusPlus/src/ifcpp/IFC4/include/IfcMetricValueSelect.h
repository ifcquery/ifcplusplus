...
class IfcMetricValueSelect : virtual public IfcPPObject
{
public:
	...
	static shared_ptr<IfcMetricValueSelect> createObjectFromStepData( const std::wstring& arg, const std::map<int,shared_ptr<IfcPPEntity> >& map );
};
