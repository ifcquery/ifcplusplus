...
public:
	...
	static shared_ptr<IfcModulusOfTranslationalSubgradeReactionSelect> createObjectFromSTEP( const std::wstring& arg, const std::map<int,shared_ptr<BuildingEntity> >& map );
};
