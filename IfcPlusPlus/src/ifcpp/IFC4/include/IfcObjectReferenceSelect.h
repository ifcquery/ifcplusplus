...
class IfcObjectReferenceSelect : virtual public IfcPPObject
{
public:
	...
	static shared_ptr<IfcObjectReferenceSelect> createObjectFromStepData( const std::wstring& arg, const std::map<int,shared_ptr<IfcPPEntity> >& map );
};
