...
class IFCQUERY_EXPORT IfcPresentationStyleSelect : virtual public BuildingObject
{
public:
	...
	static shared_ptr<IfcPresentationStyleSelect> createObjectFromSTEP( const std::wstring& arg, const std::map<int,shared_ptr<BuildingEntity> >& map );
};
