...
class IfcProductRepresentationSelect : virtual public IfcPPObject
{
public:
	...
	static shared_ptr<IfcProductRepresentationSelect> createObjectFromStepData( const std::wstring& arg, const std::map<int,shared_ptr<IfcPPEntity> >& map );
};
