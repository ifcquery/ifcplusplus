...
class IfcResourceSelect : virtual public IfcPPObject
{
public:
	IfcResourceSelect();
	~IfcResourceSelect();
	...
	static shared_ptr<IfcResourceSelect> createObjectFromStepData( const std::wstring& arg, const std::map<int,shared_ptr<IfcPPEntity> >& map );
};
