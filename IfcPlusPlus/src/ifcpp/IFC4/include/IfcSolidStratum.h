...
//ENTITY
class IFCQUERY_EXPORT IfcSolidStratum : public IfcGeotechnicalStratum
{ 
public:
	IfcSolidStratum() = default;
	IfcSolidStratum( int id );
	~IfcSolidStratum() = default;
	...
	virtual const char* className() const { return "IfcSolidStratum"; }
