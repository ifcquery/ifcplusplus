...
class IfcStructuralActivityAssignmentSelect : virtual public IfcPPObject
{
public:
	...
	static shared_ptr<IfcStructuralActivityAssignmentSelect> createObjectFromStepData( const std::wstring& arg, const std::map<int,shared_ptr<IfcPPEntity> >& map );
};
