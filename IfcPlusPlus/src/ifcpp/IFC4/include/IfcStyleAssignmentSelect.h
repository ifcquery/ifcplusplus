...
class IFCQUERY_EXPORT IfcStyleAssignmentSelect : virtual public BuildingObject
{
public:
	...
	static shared_ptr<IfcStyleAssignmentSelect> createObjectFromSTEP( const std::wstring& arg, const std::map<int,shared_ptr<BuildingEntity> >& map );
};
