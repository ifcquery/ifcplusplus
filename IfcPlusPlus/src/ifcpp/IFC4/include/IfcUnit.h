...
class IfcUnit : virtual public IfcPPObject
{
public:
	IfcUnit();
	~IfcUnit();
	...
	static shared_ptr<IfcUnit> createObjectFromStepData( const std::wstring& arg, const std::map<int,shared_ptr<IfcPPEntity> >& map );
};
