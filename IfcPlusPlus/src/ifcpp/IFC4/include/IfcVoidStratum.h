...
//ENTITY
class IFCQUERY_EXPORT IfcVoidStratum : public IfcGeotechnicalStratum
{ 
public:
	IfcVoidStratum() = default;
	IfcVoidStratum( int id );
	~IfcVoidStratum() = default;
	...
	virtual const char* className() const { return "IfcVoidStratum"; }
