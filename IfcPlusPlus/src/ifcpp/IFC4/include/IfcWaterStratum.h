...
#include "IfcGeotechnicalStratum.h"
//ENTITY
class IFCQUERY_EXPORT IfcWaterStratum : public IfcGeotechnicalStratum
{ 
public:
	IfcWaterStratum() = default;
	IfcWaterStratum( int id );
	~IfcWaterStratum() = default;
	...
	virtual const char* className() const { return "IfcWaterStratum"; }
