...
class IfcWindowTypePartitioningEnum : virtual public IfcPPObject
{
public:
	...
	static shared_ptr<IfcWindowTypePartitioningEnum> createObjectFromStepData( const std::string& arg );
