...
void IfcAlignment2DSegment::getStepParameter( std::stringstream& stream, bool ) const { stream << "#" << m_entity_id; }
...
void IfcAlignment2DSegment::getAttributes( std::vector<std::pair<std::string, shared_ptr<BuildingObject> > >& vec_attributes )
{
	IfcGeometricRepresentationItem::getAttributes( vec_attributes );
	vec_attributes.push_back( std::make_pair( "TangentialContinuity", m_TangentialContinuity ) );
	vec_attributes.push_back( std::make_pair( "StartTag", m_StartTag ) );
	vec_attributes.push_back( std::make_pair( "EndTag", m_EndTag ) );
}
void IfcAlignment2DSegment::getAttributesInverse( std::vector<std::pair<std::string, shared_ptr<BuildingObject> > >& vec_attributes_inverse )
{
