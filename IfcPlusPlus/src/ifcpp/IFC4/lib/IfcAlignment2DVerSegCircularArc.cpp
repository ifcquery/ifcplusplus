...
IfcAlignment2DVerSegCircularArc::IfcAlignment2DVerSegCircularArc( int id ) { m_entity_id = id; }
IfcAlignment2DVerSegCircularArc::~IfcAlignment2DVerSegCircularArc() {}
shared_ptr<BuildingObject> IfcAlignment2DVerSegCircularArc::getDeepCopy( BuildingCopyOptions& options )
{
	shared_ptr<IfcAlignment2DVerSegCircularArc> copy_self( new IfcAlignment2DVerSegCircularArc() );
...
{
	stream << "#" << m_entity_id << "= IFCALIGNMENT2DVERSEGCIRCULARARC" << "(";
...
void IfcAlignment2DVerSegCircularArc::getStepParameter( std::stringstream& stream, bool ) const { stream << "#" << m_entity_id; }
const std::wstring IfcAlignment2DVerSegCircularArc::toString() const { return L"IfcAlignment2DVerSegCircularArc"; }
void IfcAlignment2DVerSegCircularArc::readStepArguments( const std::vector<std::wstring>& args, const std::map<int,shared_ptr<BuildingEntity> >& map )
{
	const size_t num_args = args.size();
	if( num_args != 9 ){ std::stringstream err; err << "Wrong parameter count for entity IfcAlignment2DVerSegCircularArc, expecting 9, having " << num_args << ". Entity ID: " << m_entity_id << std::endl; throw BuildingException( err.str().c_str() ); }
	...
	m_Radius = IfcPositiveLengthMeasure::createObjectFromSTEP( args[7], map );
	m_IsConvex = IfcBoolean::createObjectFromSTEP( args[8], map );
}
void IfcAlignment2DVerSegCircularArc::getAttributes( std::vector<std::pair<std::string, shared_ptr<BuildingObject> > >& vec_attributes )
{
	IfcAlignment2DVerticalSegment::getAttributes( vec_attributes );
	vec_attributes.push_back( std::make_pair( "Radius", m_Radius ) );
	vec_attributes.push_back( std::make_pair( "IsConvex", m_IsConvex ) );
}
void IfcAlignment2DVerSegCircularArc::getAttributesInverse( std::vector<std::pair<std::string, shared_ptr<BuildingObject> > >& vec_attributes_inverse )
{
	IfcAlignment2DVerticalSegment::getAttributesInverse( vec_attributes_inverse );
}
void IfcAlignment2DVerSegCircularArc::setInverseCounterparts( shared_ptr<BuildingEntity> ptr_self_entity )
{
	IfcAlignment2DVerticalSegment::setInverseCounterparts( ptr_self_entity );
}
void IfcAlignment2DVerSegCircularArc::unlinkFromInverseCounterparts()
{
