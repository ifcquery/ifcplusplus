...
void IfcAlignment2DVerSegLine::getAttributes( std::vector<std::pair<std::string, shared_ptr<BuildingObject> > >& vec_attributes )
{
	IfcAlignment2DVerticalSegment::getAttributes( vec_attributes );
}
void IfcAlignment2DVerSegLine::getAttributesInverse( std::vector<std::pair<std::string, shared_ptr<BuildingObject> > >& vec_attributes_inverse )
{
