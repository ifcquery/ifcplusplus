...
void IfcAlignment2DVerSegParabolicArc::getStepParameter( std::stringstream& stream, bool ) const { stream << "#" << m_entity_id; }
...
void IfcAlignment2DVerSegParabolicArc::getAttributes( std::vector<std::pair<std::string, shared_ptr<BuildingObject> > >& vec_attributes )
{
	IfcAlignment2DVerticalSegment::getAttributes( vec_attributes );
	vec_attributes.push_back( std::make_pair( "ParabolaConstant", m_ParabolaConstant ) );
	vec_attributes.push_back( std::make_pair( "IsConvex", m_IsConvex ) );
}
void IfcAlignment2DVerSegParabolicArc::getAttributesInverse( std::vector<std::pair<std::string, shared_ptr<BuildingObject> > >& vec_attributes_inverse )
{
