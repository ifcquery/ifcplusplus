...
IfcBridgePart::IfcBridgePart( int id ) { m_entity_id = id; }
shared_ptr<BuildingObject> IfcBridgePart::getDeepCopy( BuildingCopyOptions& options )
{
	shared_ptr<IfcBridgePart> copy_self( new IfcBridgePart() );
	if( m_GlobalId )
	{
	...
	if( m_PredefinedType ) { copy_self->m_PredefinedType = dynamic_pointer_cast<IfcFacilityPartTypeSelect>( m_PredefinedType->getDeepCopy(options) ); }
...
{
	stream << "#" << m_entity_id << "= IFCBRIDGEPART" << "(";
...
void IfcBridgePart::getStepParameter( std::stringstream& stream, bool /*is_select_type*/ ) const { stream << "#" << m_entity_id; }
const std::wstring IfcBridgePart::toString() const { return L"IfcBridgePart"; }
void IfcBridgePart::readStepArguments( const std::vector<std::wstring>& args, const std::map<int,shared_ptr<BuildingEntity> >& map )
{
	const size_t num_args = args.size();
	if( num_args != 11 ){ std::stringstream err; err << "Wrong parameter count for entity IfcBridgePart, expecting 11, having " << num_args << ". Entity ID: " << m_entity_id << std::endl; throw BuildingException( err.str().c_str() ); }
	...
	m_PredefinedType = IfcFacilityPartTypeSelect::createObjectFromSTEP( args[9], map );
	m_UsageType = IfcFacilityUsageEnum::createObjectFromSTEP( args[10], map );
}
void IfcBridgePart::getAttributes( std::vector<std::pair<std::string, shared_ptr<BuildingObject> > >& vec_attributes ) const
{
	IfcFacilityPart::getAttributes( vec_attributes );
}
void IfcBridgePart::getAttributesInverse( std::vector<std::pair<std::string, shared_ptr<BuildingObject> > >& vec_attributes_inverse ) const
{
	IfcFacilityPart::getAttributesInverse( vec_attributes_inverse );
}
void IfcBridgePart::setInverseCounterparts( shared_ptr<BuildingEntity> ptr_self_entity )
{
	IfcFacilityPart::setInverseCounterparts( ptr_self_entity );
}
void IfcBridgePart::unlinkFromInverseCounterparts()
{
