...
shared_ptr<IfcClassificationReferenceSelect> IfcClassificationReferenceSelect::createObjectFromSTEP( const std::wstring& arg, const std::map<int,shared_ptr<BuildingEntity> >& map )
{
