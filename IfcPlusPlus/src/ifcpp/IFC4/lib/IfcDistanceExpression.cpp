...
void IfcDistanceExpression::getStepParameter( std::stringstream& stream, bool ) const { stream << "#" << m_entity_id; }
...
void IfcDistanceExpression::getAttributes( std::vector<std::pair<std::string, shared_ptr<BuildingObject> > >& vec_attributes )
{
	IfcGeometricRepresentationItem::getAttributes( vec_attributes );
	vec_attributes.push_back( std::make_pair( "DistanceAlong", m_DistanceAlong ) );
	vec_attributes.push_back( std::make_pair( "OffsetLateral", m_OffsetLateral ) );
	vec_attributes.push_back( std::make_pair( "OffsetVertical", m_OffsetVertical ) );
	vec_attributes.push_back( std::make_pair( "OffsetLongitudinal", m_OffsetLongitudinal ) );
	vec_attributes.push_back( std::make_pair( "AlongHorizontal", m_AlongHorizontal ) );
}
void IfcDistanceExpression::getAttributesInverse( std::vector<std::pair<std::string, shared_ptr<BuildingObject> > >& vec_attributes_inverse )
{
