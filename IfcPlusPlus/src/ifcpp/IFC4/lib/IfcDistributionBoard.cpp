...
IfcDistributionBoard::IfcDistributionBoard( int id ) { m_entity_id = id; }
shared_ptr<BuildingObject> IfcDistributionBoard::getDeepCopy( BuildingCopyOptions& options )
{
	shared_ptr<IfcDistributionBoard> copy_self( new IfcDistributionBoard() );
	if( m_GlobalId )
	{
...
void IfcDistributionBoard::getStepLine( std::stringstream& stream ) const
{
	stream << "#" << m_entity_id << "= IFCDISTRIBUTIONBOARD" << "(";
...
void IfcDistributionBoard::getStepParameter( std::stringstream& stream, bool /*is_select_type*/ ) const { stream << "#" << m_entity_id; }
const std::wstring IfcDistributionBoard::toString() const { return L"IfcDistributionBoard"; }
void IfcDistributionBoard::readStepArguments( const std::vector<std::wstring>& args, const std::map<int,shared_ptr<BuildingEntity> >& map )
{
	const size_t num_args = args.size();
	if( num_args != 9 ){ std::stringstream err; err << "Wrong parameter count for entity IfcDistributionBoard, expecting 9, having " << num_args << ". Entity ID: " << m_entity_id << std::endl; throw BuildingException( err.str().c_str() ); }
	...
	m_PredefinedType = IfcDistributionBoardTypeEnum::createObjectFromSTEP( args[8], map );
}
void IfcDistributionBoard::getAttributes( std::vector<std::pair<std::string, shared_ptr<BuildingObject> > >& vec_attributes ) const
{
	IfcFlowController::getAttributes( vec_attributes );
	vec_attributes.emplace_back( std::make_pair( "PredefinedType", m_PredefinedType ) );
}
void IfcDistributionBoard::getAttributesInverse( std::vector<std::pair<std::string, shared_ptr<BuildingObject> > >& vec_attributes_inverse ) const
{
	IfcFlowController::getAttributesInverse( vec_attributes_inverse );
}
void IfcDistributionBoard::setInverseCounterparts( shared_ptr<BuildingEntity> ptr_self_entity )
{
	IfcFlowController::setInverseCounterparts( ptr_self_entity );
}
void IfcDistributionBoard::unlinkFromInverseCounterparts()
{
