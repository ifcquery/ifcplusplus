...
const std::wstring IfcDistributionSystemEnum::toString() const
{
	switch( m_enum ) 
	{
		...
		case ENUM_CATENARY_SYSTEM:	return L"CATENARY_SYSTEM";
		case ENUM_OVERHEAD_CONTACTLINE_SYSTEM:	return L"OVERHEAD_CONTACTLINE_SYSTEM";
		case ENUM_RETURN_CIRCUIT:	return L"RETURN_CIRCUIT";
