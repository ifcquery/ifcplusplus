...
IfcFacilityPart::IfcFacilityPart( int id ) { m_entity_id = id; }
shared_ptr<BuildingObject> IfcFacilityPart::getDeepCopy( BuildingCopyOptions& options )
{
	shared_ptr<IfcFacilityPart> copy_self( new IfcFacilityPart() );
	if( m_GlobalId )
	{
...
void IfcFacilityPart::getStepLine( std::stringstream& stream ) const
{
	stream << "#" << m_entity_id << "= IFCFACILITYPART" << "(";
...
void IfcFacilityPart::getStepParameter( std::stringstream& stream, bool /*is_select_type*/ ) const { stream << "#" << m_entity_id; }
const std::wstring IfcFacilityPart::toString() const { return L"IfcFacilityPart"; }
void IfcFacilityPart::readStepArguments( const std::vector<std::wstring>& args, const std::map<int,shared_ptr<BuildingEntity> >& map )
{
	const size_t num_args = args.size();
	if( num_args != 11 ){ std::stringstream err; err << "Wrong parameter count for entity IfcFacilityPart, expecting 11, having " << num_args << ". Entity ID: " << m_entity_id << std::endl; throw BuildingException( err.str().c_str() ); }
...
void IfcFacilityPart::getAttributes( std::vector<std::pair<std::string, shared_ptr<BuildingObject> > >& vec_attributes ) const
{
...
void IfcFacilityPart::getAttributesInverse( std::vector<std::pair<std::string, shared_ptr<BuildingObject> > >& vec_attributes_inverse ) const
{
	IfcSpatialStructureElement::getAttributesInverse( vec_attributes_inverse );
}
void IfcFacilityPart::setInverseCounterparts( shared_ptr<BuildingEntity> ptr_self_entity )
{
	IfcSpatialStructureElement::setInverseCounterparts( ptr_self_entity );
}
void IfcFacilityPart::unlinkFromInverseCounterparts()
{
