...
IfcImpactProtectionDevice::IfcImpactProtectionDevice( int id ) { m_entity_id = id; }
shared_ptr<BuildingObject> IfcImpactProtectionDevice::getDeepCopy( BuildingCopyOptions& options )
{
	shared_ptr<IfcImpactProtectionDevice> copy_self( new IfcImpactProtectionDevice() );
	if( m_GlobalId )
	{
...
void IfcImpactProtectionDevice::getStepLine( std::stringstream& stream ) const
{
	stream << "#" << m_entity_id << "= IFCIMPACTPROTECTIONDEVICE" << "(";
...
void IfcImpactProtectionDevice::getStepParameter( std::stringstream& stream, bool /*is_select_type*/ ) const { stream << "#" << m_entity_id; }
const std::wstring IfcImpactProtectionDevice::toString() const { return L"IfcImpactProtectionDevice"; }
void IfcImpactProtectionDevice::readStepArguments( const std::vector<std::wstring>& args, const std::map<int,shared_ptr<BuildingEntity> >& map )
{
	const size_t num_args = args.size();
	if( num_args != 9 ){ std::stringstream err; err << "Wrong parameter count for entity IfcImpactProtectionDevice, expecting 9, having " << num_args << ". Entity ID: " << m_entity_id << std::endl; throw BuildingException( err.str().c_str() ); }
	...
	m_PredefinedType = IfcImpactProtectionDeviceTypeSelect::createObjectFromSTEP( args[8], map );
}
void IfcImpactProtectionDevice::getAttributes( std::vector<std::pair<std::string, shared_ptr<BuildingObject> > >& vec_attributes ) const
{
	IfcElementComponent::getAttributes( vec_attributes );
	vec_attributes.emplace_back( std::make_pair( "PredefinedType", m_PredefinedType ) );
}
void IfcImpactProtectionDevice::getAttributesInverse( std::vector<std::pair<std::string, shared_ptr<BuildingObject> > >& vec_attributes_inverse ) const
{
	IfcElementComponent::getAttributesInverse( vec_attributes_inverse );
}
void IfcImpactProtectionDevice::setInverseCounterparts( shared_ptr<BuildingEntity> ptr_self_entity )
{
	IfcElementComponent::setInverseCounterparts( ptr_self_entity );
}
void IfcImpactProtectionDevice::unlinkFromInverseCounterparts()
{
