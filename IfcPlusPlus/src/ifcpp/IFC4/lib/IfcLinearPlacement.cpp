...
void IfcLinearPlacement::getStepParameter( std::stringstream& stream, bool ) const { stream << "#" << m_entity_id; }
...
void IfcLinearPlacement::getAttributes( std::vector<std::pair<std::string, shared_ptr<BuildingObject> > >& vec_attributes )
{
	...
	vec_attributes.push_back( std::make_pair( "CartesianPosition", m_CartesianPosition ) );
}
void IfcLinearPlacement::getAttributesInverse( std::vector<std::pair<std::string, shared_ptr<BuildingObject> > >& vec_attributes_inverse )
{
