...
IfcLiquidTerminal::IfcLiquidTerminal( int id ) { m_entity_id = id; }
shared_ptr<BuildingObject> IfcLiquidTerminal::getDeepCopy( BuildingCopyOptions& options )
{
	shared_ptr<IfcLiquidTerminal> copy_self( new IfcLiquidTerminal() );
	if( m_GlobalId )
	{
...
void IfcLiquidTerminal::getStepLine( std::stringstream& stream ) const
{
	stream << "#" << m_entity_id << "= IFCLIQUIDTERMINAL" << "(";
...
void IfcLiquidTerminal::getStepParameter( std::stringstream& stream, bool /*is_select_type*/ ) const { stream << "#" << m_entity_id; }
const std::wstring IfcLiquidTerminal::toString() const { return L"IfcLiquidTerminal"; }
void IfcLiquidTerminal::readStepArguments( const std::vector<std::wstring>& args, const std::map<int,shared_ptr<BuildingEntity> >& map )
{
	const size_t num_args = args.size();
	if( num_args != 9 ){ std::stringstream err; err << "Wrong parameter count for entity IfcLiquidTerminal, expecting 9, having " << num_args << ". Entity ID: " << m_entity_id << std::endl; throw BuildingException( err.str().c_str() ); }
	...
	m_PredefinedType = IfcLiquidTerminalTypeEnum::createObjectFromSTEP( args[8], map );
}
void IfcLiquidTerminal::getAttributes( std::vector<std::pair<std::string, shared_ptr<BuildingObject> > >& vec_attributes ) const
{
	IfcFlowTerminal::getAttributes( vec_attributes );
	vec_attributes.emplace_back( std::make_pair( "PredefinedType", m_PredefinedType ) );
}
void IfcLiquidTerminal::getAttributesInverse( std::vector<std::pair<std::string, shared_ptr<BuildingObject> > >& vec_attributes_inverse ) const
{
	IfcFlowTerminal::getAttributesInverse( vec_attributes_inverse );
}
void IfcLiquidTerminal::setInverseCounterparts( shared_ptr<BuildingEntity> ptr_self_entity )
{
	IfcFlowTerminal::setInverseCounterparts( ptr_self_entity );
}
void IfcLiquidTerminal::unlinkFromInverseCounterparts()
{
