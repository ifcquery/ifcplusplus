...
IfcLiquidTerminalType::IfcLiquidTerminalType( int id ) { m_entity_id = id; }
shared_ptr<BuildingObject> IfcLiquidTerminalType::getDeepCopy( BuildingCopyOptions& options )
{
	shared_ptr<IfcLiquidTerminalType> copy_self( new IfcLiquidTerminalType() );
	if( m_GlobalId )
	{
	...
	if( m_PredefinedType ) { copy_self->m_PredefinedType = dynamic_pointer_cast<IfcLiquidTerminalTypeEnum>( m_PredefinedType->getDeepCopy(options) ); }
	return copy_self;
}
void IfcLiquidTerminalType::getStepLine( std::stringstream& stream ) const
{
	stream << "#" << m_entity_id << "= IFCLIQUIDTERMINALTYPE" << "(";
...
void IfcLiquidTerminalType::getStepParameter( std::stringstream& stream, bool /*is_select_type*/ ) const { stream << "#" << m_entity_id; }
const std::wstring IfcLiquidTerminalType::toString() const { return L"IfcLiquidTerminalType"; }
void IfcLiquidTerminalType::readStepArguments( const std::vector<std::wstring>& args, const std::map<int,shared_ptr<BuildingEntity> >& map )
{
	const size_t num_args = args.size();
	if( num_args != 10 ){ std::stringstream err; err << "Wrong parameter count for entity IfcLiquidTerminalType, expecting 10, having " << num_args << ". Entity ID: " << m_entity_id << std::endl; throw BuildingException( err.str().c_str() ); }
	...
	m_PredefinedType = IfcLiquidTerminalTypeEnum::createObjectFromSTEP( args[9], map );
}
void IfcLiquidTerminalType::getAttributes( std::vector<std::pair<std::string, shared_ptr<BuildingObject> > >& vec_attributes ) const
{
	IfcFlowTerminalType::getAttributes( vec_attributes );
	vec_attributes.emplace_back( std::make_pair( "PredefinedType", m_PredefinedType ) );
}
void IfcLiquidTerminalType::getAttributesInverse( std::vector<std::pair<std::string, shared_ptr<BuildingObject> > >& vec_attributes_inverse ) const
{
	IfcFlowTerminalType::getAttributesInverse( vec_attributes_inverse );
}
void IfcLiquidTerminalType::setInverseCounterparts( shared_ptr<BuildingEntity> ptr_self_entity )
{
	IfcFlowTerminalType::setInverseCounterparts( ptr_self_entity );
}
void IfcLiquidTerminalType::unlinkFromInverseCounterparts()
{
