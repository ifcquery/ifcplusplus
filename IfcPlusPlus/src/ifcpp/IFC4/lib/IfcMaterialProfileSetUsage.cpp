...
IfcMaterialProfileSetUsage::IfcMaterialProfileSetUsage() = default;
...
void IfcMaterialProfileSetUsage::getStepParameter( std::stringstream& stream, bool  /*is_select_type*/) const { stream << "#" << m_entity_id; }
const std::wstring IfcMaterialProfileSetUsage::toString() const { return L"IfcMaterialProfileSetUsage"; }
void IfcMaterialProfileSetUsage::readStepArguments( const std::vector<std::wstring>& args, const std::map<int,shared_ptr<BuildingEntity> >& map )
{
	const size_t num_args = args.size();
	if( num_args != 3 ){ std::stringstream err; err << "Wrong parameter count for entity IfcMaterialProfileSetUsage, expecting 3, having " << num_args << ". Entity ID: " << m_entity_id << std::endl; throw BuildingException( err.str() ); }
...
void IfcMaterialProfileSetUsage::getAttributes( std::vector<std::pair<std::string, shared_ptr<BuildingObject> > >& vec_attributes ) const
{
	...
	vec_attributes.emplace_back( "ForProfileSet", m_ForProfileSet );
	vec_attributes.emplace_back( "CardinalPoint", m_CardinalPoint );
...
void IfcMaterialProfileSetUsage::setInverseCounterparts( shared_ptr<BuildingEntity> ptr_self_entity )
{
