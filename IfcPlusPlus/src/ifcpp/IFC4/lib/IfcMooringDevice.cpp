...
IfcMooringDevice::IfcMooringDevice( int id ) { m_entity_id = id; }
shared_ptr<BuildingObject> IfcMooringDevice::getDeepCopy( BuildingCopyOptions& options )
{
	shared_ptr<IfcMooringDevice> copy_self( new IfcMooringDevice() );
	if( m_GlobalId )
	{
...
void IfcMooringDevice::getStepLine( std::stringstream& stream ) const
{
	stream << "#" << m_entity_id << "= IFCMOORINGDEVICE" << "(";
...
void IfcMooringDevice::getStepParameter( std::stringstream& stream, bool /*is_select_type*/ ) const { stream << "#" << m_entity_id; }
const std::wstring IfcMooringDevice::toString() const { return L"IfcMooringDevice"; }
void IfcMooringDevice::readStepArguments( const std::vector<std::wstring>& args, const std::map<int,shared_ptr<BuildingEntity> >& map )
{
	const size_t num_args = args.size();
	if( num_args != 9 ){ std::stringstream err; err << "Wrong parameter count for entity IfcMooringDevice, expecting 9, having " << num_args << ". Entity ID: " << m_entity_id << std::endl; throw BuildingException( err.str().c_str() ); }
	...
	m_PredefinedType = IfcMooringDeviceTypeEnum::createObjectFromSTEP( args[8], map );
}
void IfcMooringDevice::getAttributes( std::vector<std::pair<std::string, shared_ptr<BuildingObject> > >& vec_attributes ) const
{
	IfcBuiltElement::getAttributes( vec_attributes );
	vec_attributes.emplace_back( std::make_pair( "PredefinedType", m_PredefinedType ) );
}
void IfcMooringDevice::getAttributesInverse( std::vector<std::pair<std::string, shared_ptr<BuildingObject> > >& vec_attributes_inverse ) const
{
	IfcBuiltElement::getAttributesInverse( vec_attributes_inverse );
}
void IfcMooringDevice::setInverseCounterparts( shared_ptr<BuildingEntity> ptr_self_entity )
{
	IfcBuiltElement::setInverseCounterparts( ptr_self_entity );
}
void IfcMooringDevice::unlinkFromInverseCounterparts()
{
