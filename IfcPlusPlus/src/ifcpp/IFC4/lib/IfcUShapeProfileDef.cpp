...
IfcUShapeProfileDef::IfcUShapeProfileDef() = default;
IfcUShapeProfileDef::IfcUShapeProfileDef( int id ) { m_entity_id = id; }
IfcUShapeProfileDef::~IfcUShapeProfileDef() = default;
shared_ptr<BuildingObject> IfcUShapeProfileDef::getDeepCopy( BuildingCopyOptions& options )
{
...
void IfcUShapeProfileDef::getStepParameter( std::stringstream& stream, bool  /*is_select_type*/) const { stream << "#" << m_entity_id; }
const std::wstring IfcUShapeProfileDef::toString() const { return L"IfcUShapeProfileDef"; }
void IfcUShapeProfileDef::readStepArguments( const std::vector<std::wstring>& args, const std::map<int,shared_ptr<BuildingEntity> >& map )
{
	const size_t num_args = args.size();
	if( num_args != 10 ){ std::stringstream err; err << "Wrong parameter count for entity IfcUShapeProfileDef, expecting 10, having " << num_args << ". Entity ID: " << m_entity_id << std::endl; throw BuildingException( err.str() ); }
...
void IfcUShapeProfileDef::getAttributes( std::vector<std::pair<std::string, shared_ptr<BuildingObject> > >& vec_attributes ) const
{
	IfcParameterizedProfileDef::getAttributes( vec_attributes );
	vec_attributes.emplace_back( "Depth", m_Depth );
	vec_attributes.emplace_back( "FlangeWidth", m_FlangeWidth );
...
void IfcUShapeProfileDef::getAttributesInverse( std::vector<std::pair<std::string, shared_ptr<BuildingObject> > >& vec_attributes_inverse ) const
{
	IfcParameterizedProfileDef::getAttributesInverse( vec_attributes_inverse );
}
void IfcUShapeProfileDef::setInverseCounterparts( shared_ptr<BuildingEntity> ptr_self_entity )
{
