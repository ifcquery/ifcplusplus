...
IfcVibrationDamper::IfcVibrationDamper( int id ) { m_entity_id = id; }
shared_ptr<BuildingObject> IfcVibrationDamper::getDeepCopy( BuildingCopyOptions& options )
{
	shared_ptr<IfcVibrationDamper> copy_self( new IfcVibrationDamper() );
	if( m_GlobalId )
	{
...
void IfcVibrationDamper::getStepLine( std::stringstream& stream ) const
{
	stream << "#" << m_entity_id << "= IFCVIBRATIONDAMPER" << "(";
...
void IfcVibrationDamper::getStepParameter( std::stringstream& stream, bool /*is_select_type*/ ) const { stream << "#" << m_entity_id; }
const std::wstring IfcVibrationDamper::toString() const { return L"IfcVibrationDamper"; }
void IfcVibrationDamper::readStepArguments( const std::vector<std::wstring>& args, const std::map<int,shared_ptr<BuildingEntity> >& map )
{
	const size_t num_args = args.size();
	if( num_args != 9 ){ std::stringstream err; err << "Wrong parameter count for entity IfcVibrationDamper, expecting 9, having " << num_args << ". Entity ID: " << m_entity_id << std::endl; throw BuildingException( err.str().c_str() ); }
	...
	m_PredefinedType = IfcVibrationDamperTypeEnum::createObjectFromSTEP( args[8], map );
}
void IfcVibrationDamper::getAttributes( std::vector<std::pair<std::string, shared_ptr<BuildingObject> > >& vec_attributes ) const
{
	IfcElementComponent::getAttributes( vec_attributes );
	vec_attributes.emplace_back( std::make_pair( "PredefinedType", m_PredefinedType ) );
}
void IfcVibrationDamper::getAttributesInverse( std::vector<std::pair<std::string, shared_ptr<BuildingObject> > >& vec_attributes_inverse ) const
{
	IfcElementComponent::getAttributesInverse( vec_attributes_inverse );
}
void IfcVibrationDamper::setInverseCounterparts( shared_ptr<BuildingEntity> ptr_self_entity )
{
	IfcElementComponent::setInverseCounterparts( ptr_self_entity );
}
void IfcVibrationDamper::unlinkFromInverseCounterparts()
{
