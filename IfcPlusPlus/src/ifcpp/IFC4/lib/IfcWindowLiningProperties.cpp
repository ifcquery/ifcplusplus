...
IfcWindowLiningProperties::IfcWindowLiningProperties() = default;
...
void IfcWindowLiningProperties::readStepArguments( const std::vector<std::wstring>& args, const std::map<int,shared_ptr<BuildingEntity> >& map )
{
	...
	if( num_args != 16 ){ std::stringstream err; err << "Wrong parameter count for entity IfcWindowLiningProperties, expecting 16, having " << num_args << ". Entity ID: " << m_entity_id << std::endl; throw BuildingException( err.str() ); }
...
void IfcWindowLiningProperties::getAttributes( std::vector<std::pair<std::string, shared_ptr<BuildingObject> > >& vec_attributes ) const
{
	...
	vec_attributes.emplace_back( "MullionThickness", m_MullionThickness );
	vec_attributes.emplace_back( "FirstTransomOffset", m_FirstTransomOffset );
	vec_attributes.emplace_back( "SecondTransomOffset", m_SecondTransomOffset );
	vec_attributes.emplace_back( "FirstMullionOffset", m_FirstMullionOffset );
	vec_attributes.emplace_back( "SecondMullionOffset", m_SecondMullionOffset );
