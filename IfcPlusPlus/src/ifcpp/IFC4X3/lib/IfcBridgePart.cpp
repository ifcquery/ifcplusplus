...
shared_ptr<BuildingObject> IFC4X3::IfcBridgePart::getDeepCopy( BuildingCopyOptions& options )
{
	...
	if( m_PredefinedType ) { copy_self->m_PredefinedType = dynamic_pointer_cast<IfcBridgePartTypeEnum>( m_PredefinedType->getDeepCopy(options) ); }
	return copy_self;
}
