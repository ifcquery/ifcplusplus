...
void IFC4X3::IfcBuildingStorey::readStepArguments( const std::vector<std::string>& args, const BuildingModelMapType<int,shared_ptr<BuildingEntity> >& map, std::stringstream& errorStream, std::unordered_set<int>& entityIdNotFound )
{
	...
	if( num_args > 9 ){m_Elevation = IfcLengthMeasure::createObjectFromSTEP( args[9], map, errorStream, entityIdNotFound );}
