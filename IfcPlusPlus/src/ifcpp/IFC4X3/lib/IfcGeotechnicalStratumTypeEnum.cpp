...
shared_ptr<BuildingObject> IFC4X3::IfcGeotechnicalStratumTypeEnum::getDeepCopy( BuildingCopyOptions& options )
{
	shared_ptr<IfcGeotechnicalStratumTypeEnum> copy_self( new IfcGeotechnicalStratumTypeEnum() );
