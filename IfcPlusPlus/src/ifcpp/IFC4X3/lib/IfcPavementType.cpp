...
shared_ptr<BuildingObject> IFC4X3::IfcPavementType::getDeepCopy( BuildingCopyOptions& options )
{
	...
	if( m_PredefinedType ) { copy_self->m_PredefinedType = dynamic_pointer_cast<IfcPavementTypeEnum>( m_PredefinedType->getDeepCopy(options) ); }
	return copy_self;
}
