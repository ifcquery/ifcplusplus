...
shared_ptr<BuildingObject> IFC4X3::IfcPavementTypeEnum::getDeepCopy( BuildingCopyOptions& options )
{
	shared_ptr<IfcPavementTypeEnum> copy_self( new IfcPavementTypeEnum() );
