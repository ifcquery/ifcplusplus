...
void IFC4X3::IfcPropertySingleValue::readStepArguments( const std::vector<std::string>& args, const BuildingModelMapType<int,shared_ptr<BuildingEntity> >& map, std::stringstream& errorStream, std::unordered_set<int>& entityIdNotFound )
{
	...
	if( num_args > 2 ){m_NominalValue = IfcValue::createObjectFromSTEP( args[2], map, errorStream, entityIdNotFound );}
