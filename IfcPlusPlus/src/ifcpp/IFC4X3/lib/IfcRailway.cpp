...
shared_ptr<BuildingObject> IFC4X3::IfcRailway::getDeepCopy( BuildingCopyOptions& options )
{
	...
	if( m_PredefinedType ) { copy_self->m_PredefinedType = dynamic_pointer_cast<IfcRailwayTypeEnum>( m_PredefinedType->getDeepCopy(options) ); }
	return copy_self;
}
