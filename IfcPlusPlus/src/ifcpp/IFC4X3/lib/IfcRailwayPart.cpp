...
shared_ptr<BuildingObject> IFC4X3::IfcRailwayPart::getDeepCopy( BuildingCopyOptions& options )
{
	shared_ptr<IfcRailwayPart> copy_self( new IfcRailwayPart() );
	if( m_GlobalId )
	{
	...
	if( m_PredefinedType ) { copy_self->m_PredefinedType = dynamic_pointer_cast<IfcRailwayPartTypeEnum>( m_PredefinedType->getDeepCopy(options) ); }
	return copy_self;
}
