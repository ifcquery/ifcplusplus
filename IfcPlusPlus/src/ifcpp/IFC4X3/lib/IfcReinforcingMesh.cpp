...
void IFC4X3::IfcReinforcingMesh::readStepArguments( const std::vector<std::string>& args, const BuildingModelMapType<int,shared_ptr<BuildingEntity> >& map, std::stringstream& errorStream, std::unordered_set<int>& entityIdNotFound )
{
	...
	if( num_args > 9 ){m_MeshLength = IfcPositiveLengthMeasure::createObjectFromSTEP( args[9], map, errorStream, entityIdNotFound );}
	if( num_args > 10 ){m_MeshWidth = IfcPositiveLengthMeasure::createObjectFromSTEP( args[10], map, errorStream, entityIdNotFound );}
	if( num_args > 11 ){m_LongitudinalBarNominalDiameter = IfcPositiveLengthMeasure::createObjectFromSTEP( args[11], map, errorStream, entityIdNotFound );}
	if( num_args > 12 ){m_TransverseBarNominalDiameter = IfcPositiveLengthMeasure::createObjectFromSTEP( args[12], map, errorStream, entityIdNotFound );}
	if( num_args > 13 ){m_LongitudinalBarCrossSectionArea = IfcAreaMeasure::createObjectFromSTEP( args[13], map, errorStream, entityIdNotFound );}
	if( num_args > 14 ){m_TransverseBarCrossSectionArea = IfcAreaMeasure::createObjectFromSTEP( args[14], map, errorStream, entityIdNotFound );}
	if( num_args > 15 ){m_LongitudinalBarSpacing = IfcPositiveLengthMeasure::createObjectFromSTEP( args[15], map, errorStream, entityIdNotFound );}
	if( num_args > 16 ){m_TransverseBarSpacing = IfcPositiveLengthMeasure::createObjectFromSTEP( args[16], map, errorStream, entityIdNotFound );}
	if( num_args > 17 ){m_PredefinedType = IfcReinforcingMeshTypeEnum::createObjectFromSTEP( args[17], map, errorStream, entityIdNotFound );}
