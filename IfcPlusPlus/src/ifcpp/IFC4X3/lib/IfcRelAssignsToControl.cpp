...
void IFC4X3::IfcRelAssignsToControl::readStepArguments( const std::vector<std::string>& args, const BuildingModelMapType<int,shared_ptr<BuildingEntity> >& map, std::stringstream& errorStream, std::unordered_set<int>& entityIdNotFound )
{
	...
	if( num_args > 6 ){readEntityReference( args[6], m_RelatingControl, map, errorStream, entityIdNotFound );}
