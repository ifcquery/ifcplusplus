...
void IFC4X3::IfcRelAssignsToProduct::readStepArguments( const std::vector<std::string>& args, const BuildingModelMapType<int,shared_ptr<BuildingEntity> >& map, std::stringstream& errorStream, std::unordered_set<int>& entityIdNotFound )
{
	...
	if( num_args > 6 ){m_RelatingProduct = IfcProductSelect::createObjectFromSTEP( args[6], map, errorStream, entityIdNotFound );}
