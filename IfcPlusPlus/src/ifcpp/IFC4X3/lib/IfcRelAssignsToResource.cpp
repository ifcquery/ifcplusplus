...
void IFC4X3::IfcRelAssignsToResource::readStepArguments( const std::vector<std::string>& args, const BuildingModelMapType<int,shared_ptr<BuildingEntity> >& map, std::stringstream& errorStream, std::unordered_set<int>& entityIdNotFound )
{
	...
	if( num_args > 6 ){m_RelatingResource = IfcResourceSelect::createObjectFromSTEP( args[6], map, errorStream, entityIdNotFound );}
