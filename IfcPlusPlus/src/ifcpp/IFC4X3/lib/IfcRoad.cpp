...
shared_ptr<BuildingObject> IFC4X3::IfcRoad::getDeepCopy( BuildingCopyOptions& options )
{
	shared_ptr<IfcRoad> copy_self( new IfcRoad() );
	if( m_GlobalId )
	{
	...
	if( m_PredefinedType ) { copy_self->m_PredefinedType = dynamic_pointer_cast<IfcRoadTypeEnum>( m_PredefinedType->getDeepCopy(options) ); }
	return copy_self;
}
