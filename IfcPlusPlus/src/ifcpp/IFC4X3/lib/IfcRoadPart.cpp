...
shared_ptr<BuildingObject> IFC4X3::IfcRoadPart::getDeepCopy( BuildingCopyOptions& options )
{
	shared_ptr<IfcRoadPart> copy_self( new IfcRoadPart() );
	if( m_GlobalId )
	{
	...
	if( m_PredefinedType ) { copy_self->m_PredefinedType = dynamic_pointer_cast<IfcRoadPartTypeEnum>( m_PredefinedType->getDeepCopy(options) ); }
	return copy_self;
}
