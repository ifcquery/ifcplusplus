...
#include "ifcpp/IFC4X3/include/IfcSignType.h"
#include "ifcpp/IFC4X3/include/IfcSignTypeEnum.h"
#include "ifcpp/IFC4X3/include/IfcText.h"

// ENTITY IfcSignType 
IFC4X3::IfcSignType::IfcSignType( int tag ) { m_tag = tag; }
void IFC4X3::IfcSignType::getStepLine( std::stringstream& stream, size_t precision ) const
{
...
void IFC4X3::IfcSignType::getStepParameter( std::stringstream& stream, bool /*is_select_type*/, size_t /*precision*/ ) const { stream << "#" << m_tag; }
void IFC4X3::IfcSignType::readStepArguments( const std::vector<std::string>& args, const BuildingModelMapType<int,shared_ptr<BuildingEntity> >& map, std::stringstream& errorStream, std::unordered_set<int>& entityIdNotFound )
{
	...
	if( num_args > 9 ){m_PredefinedType = IfcSignTypeEnum::createObjectFromSTEP( args[9], map, errorStream, entityIdNotFound );}
	if( num_args != 10 ){ errorStream << "Wrong parameter count for entity IfcSignType, expecting 10, having " << num_args << ". Entity ID: " << m_tag << std::endl; }
}
