...
#include "ifcpp/IFC4X3/include/IfcSpaceType.h"
#include "ifcpp/IFC4X3/include/IfcSpaceTypeEnum.h"
#include "ifcpp/IFC4X3/include/IfcText.h"

// ENTITY IfcSpaceType 
IFC4X3::IfcSpaceType::IfcSpaceType( int tag ) { m_tag = tag; }
void IFC4X3::IfcSpaceType::getStepLine( std::stringstream& stream, size_t precision ) const
{
...
void IFC4X3::IfcSpaceType::getStepParameter( std::stringstream& stream, bool /*is_select_type*/, size_t /*precision*/ ) const { stream << "#" << m_tag; }
void IFC4X3::IfcSpaceType::readStepArguments( const std::vector<std::string>& args, const BuildingModelMapType<int,shared_ptr<BuildingEntity> >& map, std::stringstream& errorStream, std::unordered_set<int>& entityIdNotFound )
{
	...
	if( num_args != 11 ){ errorStream << "Wrong parameter count for entity IfcSpaceType, expecting 11, having " << num_args << ". Entity ID: " << m_tag << std::endl; }
}
