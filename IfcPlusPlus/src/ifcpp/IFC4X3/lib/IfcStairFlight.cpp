...
void IFC4X3::IfcStairFlight::getStepLine( std::stringstream& stream, size_t precision ) const
{
	...
	stream << ",";
	if( m_NumberOfRisers ) { m_NumberOfRisers->getStepParameter( stream, false, precision ); } else { stream << "$"; }
	stream << ",";
	if( m_NumberOfTreads ) { m_NumberOfTreads->getStepParameter( stream, false, precision ); } else { stream << "$"; }
	stream << ",";
	if( m_RiserHeight ) { m_RiserHeight->getStepParameter( stream, false, precision ); } else { stream << "$"; }
	stream << ",";
	if( m_TreadLength ) { m_TreadLength->getStepParameter( stream, false, precision ); } else { stream << "$"; }
	stream << ",";
