...
void IFC4X3::IfcStructuralCurveConnection::readStepArguments( const std::vector<std::string>& args, const BuildingModelMapType<int,shared_ptr<BuildingEntity> >& map, std::stringstream& errorStream, std::unordered_set<int>& entityIdNotFound )
{
	...
	if( num_args > 8 ){readEntityReference( args[8], m_AxisDirection, map, errorStream, entityIdNotFound );}
