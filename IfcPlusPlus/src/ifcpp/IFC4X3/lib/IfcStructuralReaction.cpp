...
#include "ifcpp/IFC4X3/include/IfcStructuralReaction.h"
#include "ifcpp/IFC4X3/include/IfcText.h"

// ENTITY IfcStructuralReaction 
IFC4X3::IfcStructuralReaction::IfcStructuralReaction( int tag ) { m_tag = tag; }
void IFC4X3::IfcStructuralReaction::getStepLine( std::stringstream& stream, size_t precision ) const
{
...
void IFC4X3::IfcStructuralReaction::getStepParameter( std::stringstream& stream, bool /*is_select_type*/, size_t /*precision*/ ) const { stream << "#" << m_tag; }
void IFC4X3::IfcStructuralReaction::readStepArguments( const std::vector<std::string>& args, const BuildingModelMapType<int,shared_ptr<BuildingEntity> >& map, std::stringstream& errorStream, std::unordered_set<int>& entityIdNotFound )
{
	...
	if( num_args != 9 ){ errorStream << "Wrong parameter count for entity IfcStructuralReaction, expecting 9, having " << num_args << ". Entity ID: " << m_tag << std::endl; }
}
