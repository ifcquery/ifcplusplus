...
#include "ifcpp/IFC4X3/include/IfcStructuralSurfaceMemberVarying.h"
#include "ifcpp/IFC4X3/include/IfcText.h"

// ENTITY IfcStructuralSurfaceMemberVarying 
IFC4X3::IfcStructuralSurfaceMemberVarying::IfcStructuralSurfaceMemberVarying( int tag ) { m_tag = tag; }
void IFC4X3::IfcStructuralSurfaceMemberVarying::getStepLine( std::stringstream& stream, size_t precision ) const
{
...
void IFC4X3::IfcStructuralSurfaceMemberVarying::getStepParameter( std::stringstream& stream, bool /*is_select_type*/, size_t /*precision*/ ) const { stream << "#" << m_tag; }
void IFC4X3::IfcStructuralSurfaceMemberVarying::readStepArguments( const std::vector<std::string>& args, const BuildingModelMapType<int,shared_ptr<BuildingEntity> >& map, std::stringstream& errorStream, std::unordered_set<int>& entityIdNotFound )
{
	...
	if( num_args > 7 ){m_PredefinedType = IfcStructuralSurfaceMemberTypeEnum::createObjectFromSTEP( args[7], map, errorStream, entityIdNotFound );}
	if( num_args > 8 ){m_Thickness = IfcPositiveLengthMeasure::createObjectFromSTEP( args[8], map, errorStream, entityIdNotFound );}
	if( num_args != 9 ){ errorStream << "Wrong parameter count for entity IfcStructuralSurfaceMemberVarying, expecting 9, having " << num_args << ". Entity ID: " << m_tag << std::endl; }
}
