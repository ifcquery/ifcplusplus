...
void IFC4X3::IfcTendonType::readStepArguments( const std::vector<std::string>& args, const BuildingModelMapType<int,shared_ptr<BuildingEntity> >& map, std::stringstream& errorStream, std::unordered_set<int>& entityIdNotFound )
{
	...
	if( num_args > 12 ){m_SheathDiameter = IfcPositiveLengthMeasure::createObjectFromSTEP( args[12], map, errorStream, entityIdNotFound );}
