...
shared_ptr<BuildingObject> IFC4X3::IfcTransportationDevice::getDeepCopy( BuildingCopyOptions& options )
{
	shared_ptr<IfcTransportationDevice> copy_self( new IfcTransportationDevice() );
	if( m_GlobalId )
	{
