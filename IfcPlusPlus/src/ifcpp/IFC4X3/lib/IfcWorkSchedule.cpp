...
#include "ifcpp/IFC4X3/include/IfcWorkSchedule.h"
#include "ifcpp/IFC4X3/include/IfcWorkScheduleTypeEnum.h"

// ENTITY IfcWorkSchedule 
IFC4X3::IfcWorkSchedule::IfcWorkSchedule( int tag ) { m_tag = tag; }
void IFC4X3::IfcWorkSchedule::getStepLine( std::stringstream& stream, size_t precision ) const
{
...
void IFC4X3::IfcWorkSchedule::getStepParameter( std::stringstream& stream, bool /*is_select_type*/, size_t /*precision*/ ) const { stream << "#" << m_tag; }
void IFC4X3::IfcWorkSchedule::readStepArguments( const std::vector<std::string>& args, const BuildingModelMapType<int,shared_ptr<BuildingEntity> >& map, std::stringstream& errorStream, std::unordered_set<int>& entityIdNotFound )
{
	...
	if( num_args > 13 ){m_PredefinedType = IfcWorkScheduleTypeEnum::createObjectFromSTEP( args[13], map, errorStream, entityIdNotFound );}
	if( num_args != 14 ){ errorStream << "Wrong parameter count for entity IfcWorkSchedule, expecting 14, having " << num_args << ". Entity ID: " << m_tag << std::endl; }
}
