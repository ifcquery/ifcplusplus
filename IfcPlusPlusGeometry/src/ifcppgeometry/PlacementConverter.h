...
public:
	...
	static void convertIfcObjectPlacement(		const shared_ptr<IfcObjectPlacement> object_placement,		carve::math::Matrix& matrix,	double length_factor, std::unordered_set<IfcObjectPlacement*>& already_applied );
