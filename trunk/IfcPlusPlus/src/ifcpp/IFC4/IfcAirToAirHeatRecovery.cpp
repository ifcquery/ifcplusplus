...
IfcAirToAirHeatRecovery::~IfcAirToAirHeatRecovery() {}
shared_ptr<IfcPPObject> IfcAirToAirHeatRecovery::getDeepCopy()
{
	...
	if( m_PredefinedType ) { copy_self->m_PredefinedType = dynamic_pointer_cast<IfcAirToAirHeatRecoveryTypeEnum>( m_PredefinedType->getDeepCopy() ); }
	return copy_self;
}
