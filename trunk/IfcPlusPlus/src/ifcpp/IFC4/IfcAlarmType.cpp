...
IfcAlarmType::~IfcAlarmType() {}
shared_ptr<IfcPPObject> IfcAlarmType::getDeepCopy()
{
	...
	if( m_PredefinedType ) { copy_self->m_PredefinedType = dynamic_pointer_cast<IfcAlarmTypeEnum>( m_PredefinedType->getDeepCopy() ); }
	return copy_self;
}
