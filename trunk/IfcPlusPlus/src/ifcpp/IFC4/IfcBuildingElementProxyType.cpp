...
IfcBuildingElementProxyType::~IfcBuildingElementProxyType() {}
shared_ptr<IfcPPObject> IfcBuildingElementProxyType::getDeepCopy()
{
	...
	if( m_PredefinedType ) { copy_self->m_PredefinedType = dynamic_pointer_cast<IfcBuildingElementProxyTypeEnum>( m_PredefinedType->getDeepCopy() ); }
	return copy_self;
}
