...
IfcBuildingStorey::~IfcBuildingStorey() {}
shared_ptr<IfcPPObject> IfcBuildingStorey::getDeepCopy()
{
	...
	if( m_Elevation ) { copy_self->m_Elevation = dynamic_pointer_cast<IfcLengthMeasure>( m_Elevation->getDeepCopy() ); }
	return copy_self;
}
