...
IfcCableCarrierFittingType::~IfcCableCarrierFittingType() {}
shared_ptr<IfcPPObject> IfcCableCarrierFittingType::getDeepCopy()
{
	...
	if( m_PredefinedType ) { copy_self->m_PredefinedType = dynamic_pointer_cast<IfcCableCarrierFittingTypeEnum>( m_PredefinedType->getDeepCopy() ); }
	return copy_self;
}
