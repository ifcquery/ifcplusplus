...
IfcCoilType::~IfcCoilType() {}
shared_ptr<IfcPPObject> IfcCoilType::getDeepCopy()
{
	...
	if( m_PredefinedType ) { copy_self->m_PredefinedType = dynamic_pointer_cast<IfcCoilTypeEnum>( m_PredefinedType->getDeepCopy() ); }
	return copy_self;
}
