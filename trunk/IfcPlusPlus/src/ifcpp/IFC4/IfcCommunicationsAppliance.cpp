...
IfcCommunicationsAppliance::~IfcCommunicationsAppliance() {}
shared_ptr<IfcPPObject> IfcCommunicationsAppliance::getDeepCopy()
{
	...
	if( m_PredefinedType ) { copy_self->m_PredefinedType = dynamic_pointer_cast<IfcCommunicationsApplianceTypeEnum>( m_PredefinedType->getDeepCopy() ); }
	return copy_self;
}
