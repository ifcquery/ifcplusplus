...
IfcCompressor::~IfcCompressor() {}
shared_ptr<IfcPPObject> IfcCompressor::getDeepCopy()
{
	...
	if( m_PredefinedType ) { copy_self->m_PredefinedType = dynamic_pointer_cast<IfcCompressorTypeEnum>( m_PredefinedType->getDeepCopy() ); }
	return copy_self;
}
