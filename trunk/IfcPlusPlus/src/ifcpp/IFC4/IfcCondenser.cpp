...
IfcCondenser::~IfcCondenser() {}
shared_ptr<IfcPPObject> IfcCondenser::getDeepCopy()
{
	...
	if( m_PredefinedType ) { copy_self->m_PredefinedType = dynamic_pointer_cast<IfcCondenserTypeEnum>( m_PredefinedType->getDeepCopy() ); }
	return copy_self;
}
