...
IfcConstructionEquipmentResourceType::~IfcConstructionEquipmentResourceType() {}
shared_ptr<IfcPPObject> IfcConstructionEquipmentResourceType::getDeepCopy()
{
	...
	if( m_PredefinedType ) { copy_self->m_PredefinedType = dynamic_pointer_cast<IfcConstructionEquipmentResourceTypeEnum>( m_PredefinedType->getDeepCopy() ); }
	return copy_self;
}
