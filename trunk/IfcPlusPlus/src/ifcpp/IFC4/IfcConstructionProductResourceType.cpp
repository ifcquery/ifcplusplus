...
IfcConstructionProductResourceType::~IfcConstructionProductResourceType() {}
shared_ptr<IfcPPObject> IfcConstructionProductResourceType::getDeepCopy()
{
	...
	if( m_PredefinedType ) { copy_self->m_PredefinedType = dynamic_pointer_cast<IfcConstructionProductResourceTypeEnum>( m_PredefinedType->getDeepCopy() ); }
	return copy_self;
}
