...
IfcDuctFitting::~IfcDuctFitting() {}
shared_ptr<IfcPPObject> IfcDuctFitting::getDeepCopy()
{
	...
	if( m_PredefinedType ) { copy_self->m_PredefinedType = dynamic_pointer_cast<IfcDuctFittingTypeEnum>( m_PredefinedType->getDeepCopy() ); }
	return copy_self;
}
