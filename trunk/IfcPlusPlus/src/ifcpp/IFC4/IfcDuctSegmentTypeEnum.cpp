...
IfcDuctSegmentTypeEnum::~IfcDuctSegmentTypeEnum() {}
shared_ptr<IfcPPObject> IfcDuctSegmentTypeEnum::getDeepCopy()
{
...
shared_ptr<IfcDuctSegmentTypeEnum> IfcDuctSegmentTypeEnum::createObjectFromStepData( const std::wstring& arg )
{
	// read TYPE
