...
IfcElectricMotorType::~IfcElectricMotorType() {}
shared_ptr<IfcPPObject> IfcElectricMotorType::getDeepCopy()
{
	...
	if( m_PredefinedType ) { copy_self->m_PredefinedType = dynamic_pointer_cast<IfcElectricMotorTypeEnum>( m_PredefinedType->getDeepCopy() ); }
	return copy_self;
}
