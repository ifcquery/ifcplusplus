...
IfcElectricResistanceMeasure::~IfcElectricResistanceMeasure() {}
shared_ptr<IfcPPObject> IfcElectricResistanceMeasure::getDeepCopy()
{
...
shared_ptr<IfcElectricResistanceMeasure> IfcElectricResistanceMeasure::createObjectFromStepData( const std::wstring& arg )
{
	// read TYPE
