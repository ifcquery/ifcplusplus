...
IfcEngineType::~IfcEngineType() {}
shared_ptr<IfcPPObject> IfcEngineType::getDeepCopy()
{
	...
	if( m_PredefinedType ) { copy_self->m_PredefinedType = dynamic_pointer_cast<IfcEngineTypeEnum>( m_PredefinedType->getDeepCopy() ); }
	return copy_self;
}
