...
IfcEvaporatorType::~IfcEvaporatorType() {}
shared_ptr<IfcPPObject> IfcEvaporatorType::getDeepCopy()
{
	...
	if( m_PredefinedType ) { copy_self->m_PredefinedType = dynamic_pointer_cast<IfcEvaporatorTypeEnum>( m_PredefinedType->getDeepCopy() ); }
	return copy_self;
}
