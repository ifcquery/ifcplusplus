...
IfcFanType::~IfcFanType() {}
shared_ptr<IfcPPObject> IfcFanType::getDeepCopy()
{
	...
	if( m_PredefinedType ) { copy_self->m_PredefinedType = dynamic_pointer_cast<IfcFanTypeEnum>( m_PredefinedType->getDeepCopy() ); }
	return copy_self;
}
