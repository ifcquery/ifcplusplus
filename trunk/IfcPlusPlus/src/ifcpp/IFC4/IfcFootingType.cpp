...
IfcFootingType::~IfcFootingType() {}
shared_ptr<IfcPPObject> IfcFootingType::getDeepCopy()
{
	...
	if( m_PredefinedType ) { copy_self->m_PredefinedType = dynamic_pointer_cast<IfcFootingTypeEnum>( m_PredefinedType->getDeepCopy() ); }
	return copy_self;
}
