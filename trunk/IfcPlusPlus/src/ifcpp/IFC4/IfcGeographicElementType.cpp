...
IfcGeographicElementType::~IfcGeographicElementType() {}
shared_ptr<IfcPPObject> IfcGeographicElementType::getDeepCopy()
{
	...
	if( m_PredefinedType ) { copy_self->m_PredefinedType = dynamic_pointer_cast<IfcGeographicElementTypeEnum>( m_PredefinedType->getDeepCopy() ); }
	return copy_self;
}
