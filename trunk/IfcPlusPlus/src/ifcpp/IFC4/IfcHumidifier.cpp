...
IfcHumidifier::~IfcHumidifier() {}
shared_ptr<IfcPPObject> IfcHumidifier::getDeepCopy()
{
	...
	if( m_PredefinedType ) { copy_self->m_PredefinedType = dynamic_pointer_cast<IfcHumidifierTypeEnum>( m_PredefinedType->getDeepCopy() ); }
	return copy_self;
}
