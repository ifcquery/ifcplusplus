...
IfcInterceptorType::~IfcInterceptorType() {}
shared_ptr<IfcPPObject> IfcInterceptorType::getDeepCopy()
{
	...
	if( m_PredefinedType ) { copy_self->m_PredefinedType = dynamic_pointer_cast<IfcInterceptorTypeEnum>( m_PredefinedType->getDeepCopy() ); }
	return copy_self;
}
