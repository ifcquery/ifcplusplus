...
IfcLampType::~IfcLampType() {}
shared_ptr<IfcPPObject> IfcLampType::getDeepCopy()
{
	...
	if( m_PredefinedType ) { copy_self->m_PredefinedType = dynamic_pointer_cast<IfcLampTypeEnum>( m_PredefinedType->getDeepCopy() ); }
	return copy_self;
}
