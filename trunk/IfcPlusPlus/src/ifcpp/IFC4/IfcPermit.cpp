...
IfcPermit::~IfcPermit() {}
shared_ptr<IfcPPObject> IfcPermit::getDeepCopy()
{
	...
	if( m_PredefinedType ) { copy_self->m_PredefinedType = dynamic_pointer_cast<IfcPermitTypeEnum>( m_PredefinedType->getDeepCopy() ); }
