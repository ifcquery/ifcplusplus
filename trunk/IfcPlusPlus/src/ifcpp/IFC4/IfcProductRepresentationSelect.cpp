...
IfcProductRepresentationSelect::~IfcProductRepresentationSelect() {}
shared_ptr<IfcProductRepresentationSelect> IfcProductRepresentationSelect::createObjectFromStepData( const std::string& arg, const std::map<int,shared_ptr<IfcPPEntity> >& map )
{
	// Read SELECT TYPE
