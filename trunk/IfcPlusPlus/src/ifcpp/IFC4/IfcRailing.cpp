...
IfcRailing::~IfcRailing() {}
shared_ptr<IfcPPObject> IfcRailing::getDeepCopy()
{
	...
	if( m_PredefinedType ) { copy_self->m_PredefinedType = dynamic_pointer_cast<IfcRailingTypeEnum>( m_PredefinedType->getDeepCopy() ); }
	return copy_self;
}
