...
IfcRampFlight::~IfcRampFlight() {}
shared_ptr<IfcPPObject> IfcRampFlight::getDeepCopy()
{
	...
	if( m_PredefinedType ) { copy_self->m_PredefinedType = dynamic_pointer_cast<IfcRampFlightTypeEnum>( m_PredefinedType->getDeepCopy() ); }
	return copy_self;
}
