...
IfcRelAssociatesMaterial::~IfcRelAssociatesMaterial() {}
shared_ptr<IfcPPObject> IfcRelAssociatesMaterial::getDeepCopy()
{
	...
	if( m_RelatingMaterial ) { copy_self->m_RelatingMaterial = dynamic_pointer_cast<IfcMaterialSelect>( m_RelatingMaterial->getDeepCopy() ); }
	return copy_self;
}
