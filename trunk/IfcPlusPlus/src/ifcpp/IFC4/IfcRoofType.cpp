...
IfcRoofType::~IfcRoofType() {}
shared_ptr<IfcPPObject> IfcRoofType::getDeepCopy()
{
	...
	if( m_PredefinedType ) { copy_self->m_PredefinedType = dynamic_pointer_cast<IfcRoofTypeEnum>( m_PredefinedType->getDeepCopy() ); }
	return copy_self;
}
