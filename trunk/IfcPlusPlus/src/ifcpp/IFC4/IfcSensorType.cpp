...
IfcSensorType::~IfcSensorType() {}
shared_ptr<IfcPPObject> IfcSensorType::getDeepCopy()
{
	...
	if( m_PredefinedType ) { copy_self->m_PredefinedType = dynamic_pointer_cast<IfcSensorTypeEnum>( m_PredefinedType->getDeepCopy() ); }
	return copy_self;
}
