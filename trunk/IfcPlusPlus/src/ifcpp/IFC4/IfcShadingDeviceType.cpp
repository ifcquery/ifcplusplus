...
IfcShadingDeviceType::~IfcShadingDeviceType() {}
shared_ptr<IfcPPObject> IfcShadingDeviceType::getDeepCopy()
{
	...
	if( m_PredefinedType ) { copy_self->m_PredefinedType = dynamic_pointer_cast<IfcShadingDeviceTypeEnum>( m_PredefinedType->getDeepCopy() ); }
	return copy_self;
}
