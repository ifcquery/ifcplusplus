...
IfcSolarDevice::~IfcSolarDevice() {}
shared_ptr<IfcPPObject> IfcSolarDevice::getDeepCopy()
{
	...
	if( m_PredefinedType ) { copy_self->m_PredefinedType = dynamic_pointer_cast<IfcSolarDeviceTypeEnum>( m_PredefinedType->getDeepCopy() ); }
	return copy_self;
}
