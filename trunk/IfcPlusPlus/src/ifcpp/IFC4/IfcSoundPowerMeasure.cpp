...
IfcSoundPowerMeasure::~IfcSoundPowerMeasure() {}
shared_ptr<IfcPPObject> IfcSoundPowerMeasure::getDeepCopy()
{
...
shared_ptr<IfcSoundPowerMeasure> IfcSoundPowerMeasure::createObjectFromStepData( const std::wstring& arg )
{
	// read TYPE
