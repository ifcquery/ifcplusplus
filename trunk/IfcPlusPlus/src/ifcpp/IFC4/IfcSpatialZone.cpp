...
IfcSpatialZone::~IfcSpatialZone() {}
shared_ptr<IfcPPObject> IfcSpatialZone::getDeepCopy()
{
	...
	if( m_PredefinedType ) { copy_self->m_PredefinedType = dynamic_pointer_cast<IfcSpatialZoneTypeEnum>( m_PredefinedType->getDeepCopy() ); }
	return copy_self;
}
