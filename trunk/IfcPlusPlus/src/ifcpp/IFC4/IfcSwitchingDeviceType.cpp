...
IfcSwitchingDeviceType::~IfcSwitchingDeviceType() {}
shared_ptr<IfcPPObject> IfcSwitchingDeviceType::getDeepCopy()
{
	...
	if( m_PredefinedType ) { copy_self->m_PredefinedType = dynamic_pointer_cast<IfcSwitchingDeviceTypeEnum>( m_PredefinedType->getDeepCopy() ); }
	return copy_self;
}
