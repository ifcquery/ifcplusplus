...
void IfcTShapeProfileDef::setEntity( shared_ptr<IfcPPEntity> other_entity )
{
...
void IfcTShapeProfileDef::readStepArguments( const std::vector<std::string>& args, const std::map<int,shared_ptr<IfcPPEntity> >& map )
{
