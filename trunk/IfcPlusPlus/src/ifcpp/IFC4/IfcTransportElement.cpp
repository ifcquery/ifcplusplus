...
IfcTransportElement::~IfcTransportElement() {}
shared_ptr<IfcPPObject> IfcTransportElement::getDeepCopy()
{
	...
	if( m_PredefinedType ) { copy_self->m_PredefinedType = dynamic_pointer_cast<IfcTransportElementTypeEnum>( m_PredefinedType->getDeepCopy() ); }
	return copy_self;
}
