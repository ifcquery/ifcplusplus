...
IfcWallType::~IfcWallType() {}
shared_ptr<IfcPPObject> IfcWallType::getDeepCopy()
{
	...
	if( m_PredefinedType ) { copy_self->m_PredefinedType = dynamic_pointer_cast<IfcWallTypeEnum>( m_PredefinedType->getDeepCopy() ); }
	return copy_self;
}
