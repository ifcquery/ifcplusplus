...
IfcWindowStyle::~IfcWindowStyle() {}
shared_ptr<IfcPPObject> IfcWindowStyle::getDeepCopy()
{
	...
	if( m_ConstructionType ) { copy_self->m_ConstructionType = dynamic_pointer_cast<IfcWindowStyleConstructionEnum>( m_ConstructionType->getDeepCopy() ); }
	if( m_OperationType ) { copy_self->m_OperationType = dynamic_pointer_cast<IfcWindowStyleOperationEnum>( m_OperationType->getDeepCopy() ); }
