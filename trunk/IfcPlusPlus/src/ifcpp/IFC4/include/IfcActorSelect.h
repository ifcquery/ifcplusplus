...
class IfcActorSelect : virtual public IfcPPObject
{
public:
	IfcActorSelect();
	~IfcActorSelect();
	...
	static shared_ptr<IfcActorSelect> createObjectFromStepData( const std::wstring& arg, const std::map<int,shared_ptr<IfcPPEntity> >& map );
};
