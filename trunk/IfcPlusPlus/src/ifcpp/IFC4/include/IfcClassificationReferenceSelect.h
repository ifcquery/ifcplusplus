...
class IfcClassificationReferenceSelect : virtual public IfcPPObject
{
public:
	...
	static shared_ptr<IfcClassificationReferenceSelect> createObjectFromStepData( const std::wstring& arg, const std::map<int,shared_ptr<IfcPPEntity> >& map );
};
