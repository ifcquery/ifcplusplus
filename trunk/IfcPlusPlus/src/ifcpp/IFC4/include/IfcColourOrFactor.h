...
class IfcColourOrFactor : virtual public IfcPPObject
{
public:
	IfcColourOrFactor();
	~IfcColourOrFactor();
	...
	static shared_ptr<IfcColourOrFactor> createObjectFromStepData( const std::wstring& arg, const std::map<int,shared_ptr<IfcPPEntity> >& map );
};
