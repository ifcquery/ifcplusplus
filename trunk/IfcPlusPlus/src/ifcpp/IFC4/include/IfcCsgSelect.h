...
class IfcCsgSelect : virtual public IfcPPObject
{
public:
	IfcCsgSelect();
	~IfcCsgSelect();
	...
	static shared_ptr<IfcCsgSelect> createObjectFromStepData( const std::wstring& arg, const std::map<int,shared_ptr<IfcPPEntity> >& map );
};
