...
class IfcDefinitionSelect : virtual public IfcPPObject
{
public:
	IfcDefinitionSelect();
	~IfcDefinitionSelect();
	...
	static shared_ptr<IfcDefinitionSelect> createObjectFromStepData( const std::wstring& arg, const std::map<int,shared_ptr<IfcPPEntity> >& map );
};
