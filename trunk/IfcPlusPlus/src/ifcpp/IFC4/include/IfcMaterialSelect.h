...
class IfcMaterialSelect : virtual public IfcPPObject
{
public:
	IfcMaterialSelect();
	~IfcMaterialSelect();
	...
	static shared_ptr<IfcMaterialSelect> createObjectFromStepData( const std::wstring& arg, const std::map<int,shared_ptr<IfcPPEntity> >& map );
};
