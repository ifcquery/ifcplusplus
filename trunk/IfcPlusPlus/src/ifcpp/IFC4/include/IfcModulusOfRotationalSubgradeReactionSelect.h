...
public:
	...
	static shared_ptr<IfcModulusOfRotationalSubgradeReactionSelect> createObjectFromStepData( const std::wstring& arg, const std::map<int,shared_ptr<IfcPPEntity> >& map );
};
