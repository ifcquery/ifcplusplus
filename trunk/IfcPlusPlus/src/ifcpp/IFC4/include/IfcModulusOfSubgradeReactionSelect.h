...
class IfcModulusOfSubgradeReactionSelect : virtual public IfcPPObject
{
public:
	...
	static shared_ptr<IfcModulusOfSubgradeReactionSelect> createObjectFromStepData( const std::wstring& arg, const std::map<int,shared_ptr<IfcPPEntity> >& map );
};
