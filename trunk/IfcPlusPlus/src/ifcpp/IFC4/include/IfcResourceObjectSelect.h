...
class IfcResourceObjectSelect : virtual public IfcPPObject
{
public:
	...
	static shared_ptr<IfcResourceObjectSelect> createObjectFromStepData( const std::wstring& arg, const std::map<int,shared_ptr<IfcPPEntity> >& map );
};
