...
class IfcTextFontSelect : virtual public IfcPPObject
{
public:
	IfcTextFontSelect();
	~IfcTextFontSelect();
	...
	static shared_ptr<IfcTextFontSelect> createObjectFromStepData( const std::wstring& arg, const std::map<int,shared_ptr<IfcPPEntity> >& map );
};
