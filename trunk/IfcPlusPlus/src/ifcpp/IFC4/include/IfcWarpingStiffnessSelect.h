...
class IfcWarpingStiffnessSelect : virtual public IfcPPObject
{
public:
	...
	static shared_ptr<IfcWarpingStiffnessSelect> createObjectFromStepData( const std::wstring& arg, const std::map<int,shared_ptr<IfcPPEntity> >& map );
};
